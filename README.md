# Mol-ME: Enhancing Molecular Property Prediction via Multi-Modal Alignment and Ensemble Methods

[![License](https://img.shields.io/badge/License-MIT-blue.svg)](LICENSE)

This repository contains the official implementation of **Mol-ME**, a novel multi-modal alignment framework for molecular property prediction, as described in our paper:
...
```bash
# 0. Install Git LFS (once per machine)
#    Ubuntu/Debian: sudo apt-get install git-lfs
#    macOS (Homebrew): brew install git-lfs
git lfs install

# 1. Clone the repository and pull the LFS-tracked data
...
#    The CUDA 11.8 wheels for torch / torch_cluster / torch_scatter / torch_sparse
#    are resolved automatically from the index URLs declared in requirements.txt.
